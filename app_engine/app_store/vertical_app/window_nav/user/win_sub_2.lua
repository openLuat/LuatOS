--[[
@module  win_sub_2
@summary 子窗口2（绿色），仅包含关闭按钮，关闭后主窗口自动显示
@version 1.0.0
@date    2026.06.03
@author  合宙
@usage
本文件为子窗口2业务逻辑模块，核心功能为：
1、订阅 "OPEN_SUB_WIN_2" 消息，收到消息后创建绿色子窗口
2、窗口内仅包含一个关闭按钮
3、点击关闭按钮关闭当前窗口，主窗口自动显示（图层式，上层关闭下层可见）
]]

local WIN_COLOR = 0x00FF00  -- 绿色
...
sys.subscribe("OPEN_SUB_WIN_2", open_handler)
