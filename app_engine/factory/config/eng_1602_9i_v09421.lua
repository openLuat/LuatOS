--[[
@module  config.eng_1602_9i_v09421
@summary Air1602引擎主机 9寸1024x600 RGB屏(HX8282) + NAND Flash + NES + 电池 配置文件
@version 1.0
@date    2026.06.29
@author  江访
@usage
...
return {
    -- ===== 顶层信息 =====
    name = "Engine_Air1602_AirLCD_1090_09421_V000",  -- 项目命名
    chip = "Air1602",                                   -- 主控芯片: RGB屏 + WiFi(airlink)
    baseboard = "合宙引擎AIR1602 V09421 9寸",            -- 底板型号
