--[[
@module  config.evb_1601_7i_v11
@summary Air1601 EVB 7寸1024x600 RGB屏(HX8282) + GPIO背光 + SD卡 配置文件
@version 1.0
@date    2026.06.04
@author  江访
@usage
...
return {
    -- ===== 顶层信息 =====
    name = "EVB_Air1601_7inch_1024x600_000_V011",  -- 项目命名: {类型}_{芯片}_{尺寸}_{版本}
