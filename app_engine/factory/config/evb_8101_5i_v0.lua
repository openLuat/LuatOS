--[[
@module  config.evb_8101_5i_v0
@summary Air8101 EVB 5寸800x480 RGB屏(H050IWV) + AirLCD_1020 配置文件
@version 1.0
@date    2026.06.18
@author  江访
@usage
...
return {
    -- ===== 顶层信息 =====
    name = "EVB_Air8101_AirLCD_1020_000_V020",    -- 项目命名: {类型}_{芯片}_{型号}_{版本}
    chip = "Air8101",                                 -- 主控芯片: WiFi(exnetif) + RGB屏
    baseboard = "EVB_Air8101 开发板 V2.0", -- 底板型号（与 AirLCD_1090 同底板）
    ...
    hw = {
        ...
        -- 触摸: GT911 I2C 端口1（与 AirLCD_1090 同底板，配置一致）
        tp = {
            model = "tp_gt911",
            params = {
                port = 1,                -- I2C 端口 1
