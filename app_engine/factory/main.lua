...
已实现的配置（修改 PROJECT 为以下任一值即可切换硬件）：
  ...
  "EVB_Air1601_7inch_1024x600_000_V012"        → config/evb_1601_7i_v12.lua     7寸RGB HX8282  +WiFi(airlink spi2)+4G+以太网+SD
...
-- main.lua - 程序入口文件
PROJECT = "EVB_Air8000A_3inch5_480x320_000_V020"  -- 项目命名，映射到 config/ 下的配置文件和硬件参数
