--[[
@module  main
@summary app_engine_tablet_home 主程序入口（配置驱动架构 · TabOS 界面 · display 底层初始化）
@version 1.1
@date    2026.09.15
@author  江访
]]
...
已实现的配置（修改 PROJECT 为以下任一值即可切换硬件）：
  ...
  "Engine_Air8602_9inch_1024x600_010_V000"      → config/eng_8602_9i_v0.lua     9寸RGB HX8282  +WiFi(airlink/6205)+4G(airlink/780ER2)二选一+UVC+双RS485+SD+喇叭
