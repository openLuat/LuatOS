...
sys.taskInit(function ()
    ...
    -- 第8个参数是收到消息时的回调
    local s = mqtt2.new(lte.imei(), 300, "username", "password", 1, "lbsmqtt.airm2m.com", 1884,
    {
        ["/luatos/"..(lte.imei() or "no_imei")]=0,
        ["/luatos/"..(lte.imei() or "no_imei").."/+"]=0,
    },
    ...
    while true do
        ...
        local r,d = s:pub("/luatos/pub/"..(lte.imei() or "no_imei"), 0, tostring(os.time()))
