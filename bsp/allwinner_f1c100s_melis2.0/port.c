...
typedef struct
{
    ...
    uint32_t tp_event_pos;
    uint32_t key_event_pos;
    uint32_t srv_event_pos;
	__hdle  		h_tpGraber;
	__hdle  		h_keyGraber;
    __u8 			ksrv_th_id;
}kernel_ctrlstruct;
