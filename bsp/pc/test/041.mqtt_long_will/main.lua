...
local client_id = "124sfaadsfadsf"
local user_name = "1asdfadsfdsaf"
local password = "124fasdfadsfsdf"
...
sys.taskInit(function()
    ...
    local will_topic = "/luatos/will/" .. client_id
    local will_data = "pcpcpcpcpcpcpcpcpcppcpcpcppc"
    for i = 1, 4, 1 do
        will_data = will_data .. "asdfjasdfljasdklfjaklfjaklsfjalsf123adfasfadsfadsfadsfadsfads"
    end
    will_data = will_data .. "123"
    log.info("mqtt", "will长度", #will_data)
