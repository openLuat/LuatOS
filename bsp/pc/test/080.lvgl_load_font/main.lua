...
-- 测试所使用的字体文件为 luatos.bin
-- 在 https://lvgl.io/tools/fontconverter  可以生成
]]
...
sys.taskInit(function ()
    ...
    font = lvgl.font_load("/luadb/luatos.bin")
    log.info("lvgl", "font_load", font)
	...
	lvgl.obj_set_style_local_text_font(ui.screen_plus_label, lvgl.LABEL_PART_MAIN, lvgl.STATE_DEFAULT, font)
