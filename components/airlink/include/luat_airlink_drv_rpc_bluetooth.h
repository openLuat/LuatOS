#ifndef LUAT_AIRLINK_DRV_RPC_BLUETOOTH_H
#define LUAT_AIRLINK_DRV_RPC_BLUETOOTH_H
...
int luat_airlink_drv_rpc_ble_create_gatt(luat_ble_t* luat_ble, luat_ble_gatt_service_t* luat_ble_gatt_service);
int luat_airlink_drv_rpc_ble_read_response_value(luat_ble_t* luat_ble, uint8_t conn_idx, uint16_t service_id, uint16_t att_handle, uint8_t* data, uint32_t len);
int luat_airlink_drv_rpc_ble_write_notify_value(luat_ble_t* luat_ble, uint8_t conn_idx, uint16_t service_id, uint16_t att_handle, uint8_t* data, uint16_t len);
...
#endif /* LUAT_AIRLINK_DRV_RPC_BLUETOOTH_H */
