...
/----------------------------------------------------------------------------*/
#ifndef DEF_HZ_TJPGDEC
#define DEF_HZ_TJPGDEC
...
#define JRESULT HZJRESULT
#define JRECT HZJRECT
#define JDEC HZJDEC
#define jd_prepare hz_jd_prepare
#define jd_decomp hz_jd_decomp
#define jd_mcu_load hz_jd_mcu_load
#define jd_mcu_output hz_jd_mcu_output
#define jd_restart hz_jd_restart
