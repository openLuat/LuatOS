 ...
 * @return 0 成功，<0 失败
 */
int airui_image_set_src(lv_obj_t *img, const char *src)
{
    if (img == NULL) {
 ...
 * @return 0 成功，<0 失败
 */
int airui_image_set_zoom(lv_obj_t *img, int zoom)
{
    if (img == NULL) {
        return AIRUI_ERR_INVALID_PARAM;
    }
 ...
 * @return 0 成功，<0 失败
 */
int airui_image_set_opacity(lv_obj_t *img, int opacity)
{
    if (img == NULL) {
        return AIRUI_ERR_INVALID_PARAM;
    }
