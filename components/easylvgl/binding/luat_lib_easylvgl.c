...
// Bar 模块声明
extern void easylvgl_register_bar_meta(lua_State *L);
extern int easylvgl_bar_create(lua_State *L);
...
static const rotable_Reg_t reg_easylvgl[] = {
    ...
    {"bar", ROREG_FUNC(easylvgl_bar_create)},
