...
extern const unsigned char ems_server_luac_32[];
extern const size_t ems_server_luac_32_len;
extern const unsigned char ems_server_luac_64[];
extern const size_t ems_server_luac_64_len;
