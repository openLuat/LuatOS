...
extern luat_lcd_opts_t lcd_opts_nv3041a;
...
int luat_lcd_draw_big_image(luat_lcd_conf_t* conf, const luat_color_t* img_data, uint32_t img_w, uint32_t img_h, int16_t x, int16_t y, uint8_t swap);
