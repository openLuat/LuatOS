...
#define LUAT_LV_INDEV_RLT     {"indev_drv_init", luat_lv_indev_drv_init, 0},\
    {"indev_drv_register", luat_lv_indev_drv_register, 0},\
    {"indev_drv_update", luat_lv_indev_drv_update, 0},\
    {"indev_get_next", luat_lv_indev_get_next, 0},\
    {"indev_get_act", luat_lv_indev_get_act, 0},\
    {"indev_get_type", luat_lv_indev_get_type, 0},\
    {"indev_reset", luat_lv_indev_reset, 0},\
    {"indev_reset_long_press", luat_lv_indev_reset_long_press, 0},\
    {"indev_enable", luat_lv_indev_enable, 0},\
    {"indev_set_cursor", luat_lv_indev_set_cursor, 0},\
    {"indev_set_group", luat_lv_indev_set_group, 0},\
    {"indev_get_point", luat_lv_indev_get_point, 0},\
    {"indev_get_gesture_dir", luat_lv_indev_get_gesture_dir, 0},\
    {"indev_get_key", luat_lv_indev_get_key, 0},\
    {"indev_is_dragging", luat_lv_indev_is_dragging, 0},\
    {"indev_get_vect", luat_lv_indev_get_vect, 0},\
    {"indev_finish_drag", luat_lv_indev_finish_drag, 0},\
    {"indev_wait_release", luat_lv_indev_wait_release, 0},\
    {"indev_get_obj_act", luat_lv_indev_get_obj_act, 0},\
    {"indev_search_obj", luat_lv_indev_search_obj, 0},\
    {"indev_get_read_task", luat_lv_indev_get_read_task, 0},\
...
#define LUAT_LV_IMG_BUF_RLT     {"img_buf_alloc", luat_lv_img_buf_alloc, 0},\
...
#define LUAT_LV_IMG_DECODER_RLT     {"img_decoder_get_info", luat_lv_img_decoder_get_info, 0},\
...
// prefix lv_misc lv_async
int luat_lv_async_call(lua_State *L);

#define LUAT_LV_ASYNC_RLT     {"async_call", luat_lv_async_call, 0},\
...
#define LUAT_LV_FS_RLT     {"fs_drv_init", luat_lv_fs_drv_init, 0},\
    {"fs_drv_register", luat_lv_fs_drv_register, 0},\
    {"fs_get_drv", luat_lv_fs_get_drv, 0},\
    {"fs_is_ready", luat_lv_fs_is_ready, 0},\
    {"fs_open", luat_lv_fs_open, 0},\
    {"fs_close", luat_lv_fs_close, 0},\
    {"fs_remove", luat_lv_fs_remove, 0},\
    {"fs_read", luat_lv_fs_read, 0},\
    {"fs_write", luat_lv_fs_write, 0},\
    {"fs_seek", luat_lv_fs_seek, 0},\
    {"fs_tell", luat_lv_fs_tell, 0},\
    {"fs_trunc", luat_lv_fs_trunc, 0},\
    {"fs_size", luat_lv_fs_size, 0},\
    {"fs_rename", luat_lv_fs_rename, 0},\
    {"fs_dir_open", luat_lv_fs_dir_open, 0},\
    {"fs_dir_read", luat_lv_fs_dir_read, 0},\
    {"fs_dir_close", luat_lv_fs_dir_close, 0},\
    {"fs_free_space", luat_lv_fs_free_space, 0},\
    {"fs_get_letters", luat_lv_fs_get_letters, 0},\
    {"fs_get_ext", luat_lv_fs_get_ext, 0},\
    {"fs_up", luat_lv_fs_up, 0},\
    {"fs_get_last", luat_lv_fs_get_last, 0},\

// prefix lv_misc lv_mem
...
#define LUAT_LV_MEM_RLT     {"mem_alloc", luat_lv_mem_alloc, 0},\
    {"mem_free", luat_lv_mem_free, 0},\
    {"mem_realloc", luat_lv_mem_realloc, 0},\
    {"mem_defrag", luat_lv_mem_defrag, 0},\
    {"mem_test", luat_lv_mem_test, 0},\
    {"mem_monitor", luat_lv_mem_monitor, 0},\
