...
int luat_lv_theme_empty_init(lua_State *L) {
    ...
    lv_font_t* font_small = (lv_font_t*)lua_checkinteger(L, 4);
    lv_font_t* font_normal = (lv_font_t*)lua_checkinteger(L, 5);
    lv_font_t* font_subtitle = (lv_font_t*)lua_checkinteger(L, 6);
    lv_font_t* font_title = (lv_font_t*)lua_checkinteger(L, 7);
    lv_theme_t* ret = NULL;
