...
static void *luat_lv_fs_open(struct _lv_fs_drv_t * drv, const char * path, lv_fs_mode_t mode);
...
static void *luat_lv_fs_dir_open(struct _lv_fs_drv_t * drv, const char * path);
