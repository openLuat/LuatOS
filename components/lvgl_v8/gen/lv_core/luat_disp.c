...
int luat_lv_disp_get_physical_hor_res(lua_State *L) {
    LV_DEBUG("CALL lv_disp_get_physical_hor_res");
    lv_disp_t* disp = (lv_disp_t*)lua_touserdata(L, 1);
    lv_coord_t ret;
    ret = lv_disp_get_physical_hor_res(disp);
    lua_pushinteger(L, ret);
    return 1;
}
...
int luat_lv_disp_get_physical_ver_res(lua_State *L) {
    LV_DEBUG("CALL lv_disp_get_physical_ver_res");
    lv_disp_t* disp = (lv_disp_t*)lua_touserdata(L, 1);
    lv_coord_t ret;
    ret = lv_disp_get_physical_ver_res(disp);
    lua_pushinteger(L, ret);
    return 1;
}
...
int luat_lv_disp_get_offset_x(lua_State *L) {
    LV_DEBUG("CALL lv_disp_get_offset_x");
    lv_disp_t* disp = (lv_disp_t*)lua_touserdata(L, 1);
    lv_coord_t ret;
    ret = lv_disp_get_offset_x(disp);
    lua_pushinteger(L, ret);
    return 1;
}
...
int luat_lv_disp_get_offset_y(lua_State *L) {
    LV_DEBUG("CALL lv_disp_get_offset_y");
    lv_disp_t* disp = (lv_disp_t*)lua_touserdata(L, 1);
    lv_coord_t ret;
    ret = lv_disp_get_offset_y(disp);
    lua_pushinteger(L, ret);
    return 1;
}
