...
#include "amrwb_enc_oper_32b.h"
#include "math_op.h"
#include "amrwb_enc_cnst.h"
#include "acelp.h"                         /* prototype of functions    */
#include "bits.h"
#include "amrwb_enc_dtx.h"
	      ...
	      )
{
	...
	for (i = 0; i < DTX_HIST_SIZE; i++)
	{
		/* Division by DTX_HIST_SIZE = 8 has been done in dtx_buffer_amrwb_enc. log_en is in Q10 */
...
/**************************************************************************
*
* Function    : dtx_buffer_amrwb_enc Purpose     : handles the DTX buffer
*
**************************************************************************/
Word16 dtx_buffer_amrwb_enc(
		dtx_encState * st,                    /* i/o : State struct                    */
		...
		)
{
	...
	Log2_amrwb_enc(enr, &log_en_e, &log_en_m);
