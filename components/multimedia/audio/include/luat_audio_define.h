...
enum {
    ...
    LUAT_AUDIO_DRIVER_CONFIG_PARAM_ADC_DIG_GAIN = 0x424b0101,  /**< Air8101(BK7258) ADC 数字增益参数 */
    LUAT_AUDIO_DRIVER_CONFIG_PARAM_ADC_ANA_GAIN = 0x424b0102,  /**< Air8101(BK7258) ADC 模拟增益参数 */
