...
enum{
    ...
    LUAT_MULTIMEDIA_DATA_TYPE_SPEEX_NB,   // Speex 窄带 8kHz
    LUAT_MULTIMEDIA_DATA_TYPE_SPEEX_WB,   // Speex 宽带 16kHz
    LUAT_MULTIMEDIA_DATA_TYPE_SPEEX_UWB   // Speex 超宽带 32kHz
};
...
enum {
    ...
    AUDIO_EVENT_PLAY_MULTI_FILES = 4,
};
