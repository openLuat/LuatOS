 ...
 * Mapper 243 — SA-020A (Sachen).
 * Like mapper 79 (NINA-03/06) but with a different register decode.
 * Write to $4100 area: bits[2:0] → CHR bank; bit[3] → PRG bank.
 */
...
static void mapper243_update_banks(nes_t* nes) {
