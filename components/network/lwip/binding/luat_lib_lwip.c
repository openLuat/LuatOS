...
static const rotable_Reg reg_lwip[] =
{
    ...
    { "mqtt_cb",            luat_lwip_mqtt_cb},
    { "mqtt_arg",            luat_lwip_mqtt_cb},
    { "mqtt_client_connect",            luat_lwip_mqtt_client_connect},
    { "mqtt_connect",            luat_lwip_mqtt_client_connect},
    { "mqtt_disconnect",            luat_lwip_mqtt_disconnect},
    { "mqtt_client_is_connected",            luat_lwip_mqtt_client_is_connected},
    { "mqtt_is_connected",            luat_lwip_mqtt_client_is_connected},
    { "mqtt_subscribe",            luat_lwip_mqtt_subscribe},
    { "mqtt_unsubscribe",            luat_lwip_mqtt_unsubscribe},
    { "mqtt_publish",            luat_lwip_mqtt_publish},
    { "mqtt_free",            luat_lwip_mqtt_free},
  /** Accepted */
