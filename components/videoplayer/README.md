...
`videoplayer` 是 LuatOS 的视频播放组件，支持 MJPG 和 MP4+H264 格式的视频解码与播放。
...
```c
#define LUAT_USE_H264 1
```

MJPG 软件解码依赖 `LUAT_USE_TJPGD`。
