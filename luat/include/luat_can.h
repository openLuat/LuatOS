 ...
 * @param can_id 总线序号
 * @param node_id 节点id，标准格式11位或者扩展格式29位，根据is_extend决定
...
/**
 * @brief 设置can总线接收消息的过滤模式，当luat_can_set_node不能满足时使用，过滤模式比较复杂，请参考SJA1000的Pelican模式下滤波
 * @param can_id 总线序号
