...
#endif
// 新增一批特殊常量, WAKEUP0-56, 对应BK72xx环境下的休眠唤醒引脚定义
#ifdef __BK72XX__
    { "WAKEUP0",         ROREG_INT(64 + 0) },
    { "WAKEUP1",         ROREG_INT(64 + 1) },
    { "WAKEUP2",         ROREG_INT(64 + 2) },
    { "WAKEUP3",         ROREG_INT(64 + 3) },
    { "WAKEUP4",         ROREG_INT(64 + 4) },
    { "WAKEUP5",         ROREG_INT(64 + 5) },
    { "WAKEUP6",         ROREG_INT(64 + 6) },
    { "WAKEUP7",         ROREG_INT(64 + 7) },
    { "WAKEUP8",         ROREG_INT(64 + 8) },
    { "WAKEUP9",         ROREG_INT(64 + 9) },
    // { "WAKEUP10",        ROREG_INT(64 + 10) }, // UART0_TX
    // { "WAKEUP11",        ROREG_INT(64 + 11) }, // UART0_RX
    { "WAKEUP12",        ROREG_INT(64 + 12) },
    { "WAKEUP13",        ROREG_INT(64 + 13) },
    { "WAKEUP14",        ROREG_INT(64 + 14) },
    { "WAKEUP15",        ROREG_INT(64 + 15) },
    { "WAKEUP16",        ROREG_INT(64 + 16) },
    { "WAKEUP17",        ROREG_INT(64 + 17) },
    { "WAKEUP18",        ROREG_INT(64 + 18) },
    { "WAKEUP19",        ROREG_INT(64 + 19) },
    { "WAKEUP20",        ROREG_INT(64 + 20) },
    { "WAKEUP21",        ROREG_INT(64 + 21) },
    { "WAKEUP22",        ROREG_INT(64 + 22) },
    { "WAKEUP23",        ROREG_INT(64 + 23) },
    { "WAKEUP24",        ROREG_INT(64 + 24) },
    { "WAKEUP25",        ROREG_INT(64 + 25) },
    { "WAKEUP26",        ROREG_INT(64 + 26) },
    { "WAKEUP27",        ROREG_INT(64 + 27) },
    { "WAKEUP28",        ROREG_INT(64 + 28) },
    { "WAKEUP29",        ROREG_INT(64 + 29) },
    { "WAKEUP30",        ROREG_INT(64 + 30) },
    { "WAKEUP31",        ROREG_INT(64 + 31) },
    { "WAKEUP32",        ROREG_INT(64 + 32) },
    { "WAKEUP33",        ROREG_INT(64 + 33) },
    { "WAKEUP34",        ROREG_INT(64 + 34) },
    { "WAKEUP35",        ROREG_INT(64 + 35) },
    { "WAKEUP36",        ROREG_INT(64 + 36) },
    { "WAKEUP37",        ROREG_INT(64 + 37) },
    { "WAKEUP38",        ROREG_INT(64 + 38) },
    { "WAKEUP39",        ROREG_INT(64 + 39) },
    { "WAKEUP40",        ROREG_INT(64 + 40) },
    { "WAKEUP41",        ROREG_INT(64 + 41) },
    { "WAKEUP42",        ROREG_INT(64 + 42) },
    { "WAKEUP43",        ROREG_INT(64 + 43) },
    { "WAKEUP44",        ROREG_INT(64 + 44) },
    { "WAKEUP45",        ROREG_INT(64 + 45) },
    { "WAKEUP46",        ROREG_INT(64 + 46) },
    { "WAKEUP47",        ROREG_INT(64 + 47) },
    { "WAKEUP48",        ROREG_INT(64 + 48) },
    { "WAKEUP49",        ROREG_INT(64 + 49) },
    { "WAKEUP50",        ROREG_INT(64 + 50) },
    { "WAKEUP51",        ROREG_INT(64 + 51) },
    { "WAKEUP52",        ROREG_INT(64 + 52) },
    { "WAKEUP53",        ROREG_INT(64 + 53) },
    { "WAKEUP54",        ROREG_INT(64 + 54) },
    { "WAKEUP55",        ROREG_INT(64 + 55) },
    { "WAKEUP56",        ROREG_INT(64 + 56) },
#endif
	{ NULL,             ROREG_INT(0) }
};
