...
local config = {
    ...
    download = {
        remote_file = "/source2.txt",      -- 服务器上要下载的文件
...
local function ftp_upload_file()
    ...
    local function ftp_upload_result()
        ...
        log.error("文件上传失败, 错误信息:", err or "未知错误")
        return false
    end
