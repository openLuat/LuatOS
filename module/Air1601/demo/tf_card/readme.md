...
拨码开关位置请参考如下文档串口烧录章节[1601开发板使用说明](https://e3zt58hesn.feishu.cn/wiki/XZq2wYHL7i7YaDkRKaBclzTEnTb)

3、使用4g airlink网络接线方式请参考如下文档4g章节[1601开发板使用说明](https://e3zt58hesn.feishu.cn/wiki/XZq2wYHL7i7YaDkRKaBclzTEnTb)

4、使用以太网网络接线方式请参考如下文档以太网章节[1601开发板使用说明](https://e3zt58hesn.feishu.cn/wiki/XZq2wYHL7i7YaDkRKaBclzTEnTb)
