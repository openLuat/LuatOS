...
local function create_ui()
    ...
    -- 顶部标题栏
    local title_bar = airui.container({ parent = main_container, x = 0, y = 0, w = 1024, h = 60, color = 0x3F51B5 })
    airui.label({ parent = title_bar, x = 10, y = 10, w = 200, h = 40, text = "温度历史", font_size = 32, color = 0xfefefe })
    
    -- 返回按钮
    local back_btn = airui.container({ parent = title_bar, x = 924, y = 10, w = 80, h = 40, color = 0x2195F6, radius = 5,
        on_click = function() exwin.close(win_id) end
    })
    airui.label({ parent = back_btn, x = 10, y = 10, w = 50, h = 20, text = "返回", font_size = 16, color = 0xfefefe, align = airui.TEXT_ALIGN_CENTER })

    -- 图表区域
    chart = airui.chart({
        parent = main_container,
        x = 50, y = 80, w = 924, h = 460,
        y_min = 0, y_max = 50,
        point_count = 20,
        line_color =0x00b4ff,
        line_width = 2,
