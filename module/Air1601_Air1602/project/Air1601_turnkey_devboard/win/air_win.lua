...
local function create_ui()
    ...
    airui.label({ parent = title_bar, x = 10, y = 10, w = 200, h = 40, text = "空气质量历史", font_size = 32, color = 0xfefefe })
    ...
    airui.label({ parent = back_btn, x = 10, y = 10, w = 50, h = 20, text = "返回", font_size = 16, color = 0xfefefe, align =
