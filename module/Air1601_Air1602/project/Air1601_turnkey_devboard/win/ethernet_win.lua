...
local function create_ui()
    ...
    local back_btn = airui.container({ parent = header, x = 924, y = 10, w = 80, h = 40, color = 0x2195F6, radius = 5,
    ...
    airui.label({ parent = header, x = 10, y = 10, w = 864, h = 40, align = airui.TEXT_ALIGN_CENTER, text="以太网", font_size=32, color=0xffffff })

    content = airui.container({ parent = main_container, x=0, y=60, w=1024, h=500, color=0xF3F4F6 })
