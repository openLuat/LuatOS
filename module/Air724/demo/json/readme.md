...
使用 Air724UG 核心板搭配 json 库演示 json 序列化与反序列化功能；
...
2、[Air724 LuatOS固件](https://docs.openluat.com/air724_soc/luatos/firmware/version/)（理论上最新版本固件也可以，如果使用最新版本的固件不可以，可以烧录开发本demo时使用的固件对比验证）
