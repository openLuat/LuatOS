...
2、log_test.lua：日志功能测试模块，演示Air724UG的日志输出功能；
...
2、TYPE-C USB数据线一根，Air724UG核心板和数据线的硬件接线方式为：
...
2、[Air724 LuatOS固件](https://docs.openluat.com/air724_soc/luatos/firmware/version/)
...
``` lua
[2025-10-25 15:49:25.278][000000000.654] I/user.main project name is  logdemo version is  001.999.000
