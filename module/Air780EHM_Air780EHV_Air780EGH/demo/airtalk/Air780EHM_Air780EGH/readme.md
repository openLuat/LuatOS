...
2、Air780EHM V2018版本固件,选择支持对讲功能的固件，[不同版本区别](https://docs.openluat.com/air780epm/luatos/firmware/version/)

 Air780EGH V2018版本固件，选择支持对讲功能的固件，[不同版本区别](https://docs.openluat.com/air780egh/luatos/firmware/version/)

3、 luatos需要的脚本和资源文件
- 脚本和资源文件[点我浏览所有文件](https://gitee.com/openLuat/LuatOS/tree/master/module/Air780EHM_Air780EHV_Air780EGH/demo/airtalk/Air780EHM_Air780EGH)

- 准备好软件环境之后，接下来查看 [如何烧录项目文件到Air780EGH核心板](https://docs.openluat.com/air780egh/luatos/common/hwenv/) ，将本篇文章中演示使用的项目文件烧录到Air780EHM/Air780EGH核心板中。
...
8、 点击BOOT 按键，会选择指定终端ID的目标设备，进行一对一对讲，再按一次Boot键或powerkey键结束对讲。
- 按下Boot键，启动一对一对讲流程
- 向指定设备（终端ID：78122397）发起对讲请求
...
9、 点击POWERKEY按键，会进行广播，所有群组内的人，都会收到对讲消息，再按一次Boot键或powerkey键结束广播。
- 按下Power键，启动广播对讲
...
10、当其他设备或手机/PC的web网页端对设备发起一对一对讲。
