...
@summary Air780EHM/Air780EGH 通过 UART1 连接 VB7014F 语音芯片的录音与播放演示（PCM 流式）
@version 1.0
@date    2026.09.02
@author  拓毅恒
@usage
...
功能说明：
  本 demo 演示 Air780EHM / Air780EGH 通过 UART1（波特率固定 2M）连接合宙 VB7014F 语音芯片，
...
硬件连接：
  - Air780EHM/Air780EGH 的 UART1 对接 VB7014F 串口，波特率 2M
