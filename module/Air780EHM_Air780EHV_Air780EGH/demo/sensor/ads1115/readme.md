...
**推荐使用硬件 I2C 模式**：Air780EPM 使用 I2C1（PIN66=SDA, PIN67=SCL），占用 CPU 少、通信稳定。本 demo 默认使用硬件 I2C 模式演示，也支持软件 I2C 模式（任意 GPIO 接线，通过 `ads1115_demo.lua` 中 `MODE` 变量切换）。
...
<table>
<tr>
<td>Air780EXX 核心板<br/></td><td>ADS1115 模块<br/></td></tr>
<tr>
<td>3.3V（VDD_EXT）<br/></td><td>VCC<br/></td></tr>
<tr>
<td>GND<br/></td><td>GND<br/></td></tr>
<tr>
<td>PIN67（I2C1_SCL）<br/></td><td>SCL<br/></td></tr>
<tr>
<td>PIN66（I2C1_SDA）<br/></td><td>SDA<br/></td></tr>
<tr>
...
> 说明：接线时注意杜邦线不宜过长，以免通信不稳定。被测电压超过 3.3V 时必须电阻分压后接入 AIN 引脚。
...
- [点击下载Air780EHM系列最新版本内核固件](https://gitee.com/link?target=https%3A%2F%2Fdocs.openluat.com%2Fair780epm%2Fluatos%2Ffirmware%2F780ehm_version%2F)，demo所使用的是 LuatOS-SoC_V2050_Air780EHM 1号固件
- [点击下载Air780EHV系列最新版本内核固件](https://gitee.com/link?target=https%3A%2F%2Fdocs.openluat.com%2Fair780ehv%2Fluatos%2Ffirmware%2Fversion%2F)，demo所使用的是 LuatOS-SoC_V2050_Air780EHV 1号固件
- [点击下载Air780EGH系列最新版本内核固件](https://gitee.com/link?target=https%3A%2F%2Fdocs.openluat.com%2Fair780egh%2Fluatos%2Ffirmware%2Fversion%2F)，demo所使用的是 LuatOS-SoC_V2050_Air780EGH 1号固件
