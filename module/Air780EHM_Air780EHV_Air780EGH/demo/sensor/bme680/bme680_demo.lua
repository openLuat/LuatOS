...
Air780EHM/Air780EHV/Air780EGH 接线（软件 I2C）：
  SCL = GPIO31
  SDA = GPIO30
]]
...
local init_config
if MODE == 1 then
    -- 软件 I2C：SCL/SDA 用任意 GPIO，Air780EHM/Air780EHV/Air780EGH 接线示例用 GPIO31/GPIO30
    init_config = {scl = 31, sda = 30}
elseif MODE == 2 then
    -- 硬件 I2C：i2c_id 为总线号（Air780EHM 用 1），不传 scl/sda 时无总线恢复能力
