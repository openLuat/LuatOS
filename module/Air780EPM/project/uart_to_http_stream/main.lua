--[[
@module  main
@summary LuatOS用户应用脚本文件入口，UART数据流式上传到HTTP服务器
@version 1.0
@date    2025.07.28
@author  马梦阳
@usage
本demo演示的核心功能为：
1、通过UART串口从PC端获取文件数据（文件大小+分片数据）
2、使用httpplus扩展库的fill_data_func流式上传功能，将UART接收的数据流式上传到HTTP服务器
