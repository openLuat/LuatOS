...
local function on_destroy()
    ...
    win_id = nil
    log.info("label_win", "窗口销毁")
end

local function on_get_focus()
    log.info("label_win", "窗口获得焦点")
end

local function on_lose_focus()
    log.info("label_win", "窗口失去焦点")
end

sys.subscribe("OPEN_LABEL_WIN", function()
    if not exwin.is_active(win_id) then
        ...
        log.info("label_win", "窗口打开，ID:", win_id)
    end
end)