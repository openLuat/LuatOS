...
注意：适用于Air8000D，Air8000DB，Air8000T三款没有内置蓝牙功能的模组
...
1、使用Air8000 心板搭配Air5101S开发板演示 exril_5101 功能；
...
2、演示功能包括：
    ...
    - 演示Air5101S的看门狗功能，当看门狗喂狗超时，会重启Air8000；
...
4、TYPE-C USB数据线一根，Air8000核心板和数据线的硬件接线方式为：

- Air8000核心板通过TYPE-C USB口供电，核心板正面的 ON/OFF 拨动开关 拨到ON一端；
...
Air8000 与 Air5101S 开发板接线:

| Air8000 引脚 | Air5101S 开发板引脚 | 
| :-----------  | :---------------  |
| 3.3V          | VBAT              |
| GND           | GND               | 
| RX            | TX                | 
