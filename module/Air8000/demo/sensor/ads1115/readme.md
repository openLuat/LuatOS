...
**推荐使用硬件 I2C 模式**：Air8000EPM 使用 I2C0，占用 CPU 少、通信稳定。本 demo 默认使用硬件 I2C 模式演示，也支持软件 I2C 模式（任意 GPIO 接线，通过 `ads1115_demo.lua` 中 `MODE` 变量切换）。
...
![](https://docs.openluat.com/cdn/image/Air8000/8000_ads1115.jpg)
...
<table>
<tr>
<td>Air8000 核心板<br/></td><td>ADS1115 模块<br/></td></tr>
<tr>
<td>VDD_EXT<br/></td><td>VCC<br/></td></tr>
<tr>
<td>GND<br/></td><td>GND<br/></td></tr>
<tr>
<td>I2C0_SCL<br/></td><td>SCL<br/></td></tr>
<tr>
<td>I2C0_SDA<br/></td><td>SDA<br/></td></tr>
<tr>
<td>GND<br/></td><td>ADDR（设备地址 0x48）<br/></td></tr>
<tr>
<td>GPIO21<br/></td><td>ALRT（比较器中断，[3/4] 使用）<br/></td></tr>
<tr>
...
- [点击下载Air8000系列最新版本内核固件](https://docs.openluat.com/air8000/luatos/firmware/)，demo所使用的是 LuatOS@Air8000  V2050-1固件
...
3. **比较器中断不触发**：
   ...
   - 确认 ALRT 引脚已接 GPIO21，并核对 `ALERT_GPIO` 常量
