...
<table>
<tr>
<td>组件样式<br/></td><td>组件样式<br/></td><td>输入法<br/></td></tr>
<tr>
<td><img src="https://docs.openLuat.com/cdn/image/exeasyui_all_component_1.png" width="150" /><br/></td><td><img src="https://docs.openLuat.com/cdn/image/exeasyui_all_component_2.png" width="150" /><br/></td><td><img src="https://docs.openLuat.com/cdn/image/exeasyui_input.png" width="150" /><br/></td></tr>
</table>
...
1. 点击下载：[Luatools v3 下载调试工具](https://luatos.com/luatools/download/last)
...
1. 下载运行所需固件，点击资源管理--选择 Air8000 的 LuatOS 固件--下载最新版本的 1 号固件和 14 号固件
   ...
   ![](https://docs.openLuat.com/cdn/image/Air8000使用PC模拟器下载固件.png)
...
3. 选择固件刚才下载的固件--点击打开，路径在 Luatools 目录下 resource\LuatOS_Air8000\LuatOS-SoC_VXXXX_Air8000
   ...
   ![](https://docs.openLuat.com/cdn/image/Air8000选择固件.png)

4. 将下载的 demo 图片资源和.lua文件拖入到项目管理内的脚本和资源列表区域--勾选添加默认 lib--点击模拟器运行--出来的界面就是 demo 在实际设备上运行界面的仿真，可以用鼠标进行交互

   ![](https://docs.openLuat.com/cdn/image/Air8000PC模拟器运行.png)
...
- 演示所使用的是 Air8000 核心板与 AirFONTS_1000 配件板
