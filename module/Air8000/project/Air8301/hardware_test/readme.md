...
Air8301 硬件测试固件基于 **Air8000W** 主控（4G + WiFi + BLE + SPI 屏），通过 4.3 寸 ST6201 触摸屏提供人机交互，用于对 Air8301 硬件板各外设进行功能测试，测试项包括：
...
| 硬件 | 数量 | 备注 |
|------|------|------|
| Air8301 硬件测试板 | 1 | 基于 Air8000W 主控，4.3寸 480x272 ST6201 SPI 屏 + GT911 触摸 |
| 电源 | 1 | 适配测试板输入电压 |
...
2. 编译下载脚本固件至 Air8301 硬件测试板（Air8000W 芯片，选对应 SOC 固件）
