...
local function netdrv_multiple_task_func()
    ...
    -- 本demo使用EXB_8000W_CH390测试，功能板上的硬件配置为：
    -- GPIO140为CH390H以太网芯片的供电使能控制引脚
    -- 使用spi1，片选引脚使用GPIO12
    log.info("ch390", "打开LDO供电")
    gpio.setup(16, 1, gpio.PULLUP) -- 打开ch390供电
    gpio.setup(17, 1, gpio.PULLUP) -- 打开ch390供电
    ...
    -- netdrv.CH390外挂CH390
    -- SPI ID 1, 片选 GPIO12,中断引脚 GPIO21
