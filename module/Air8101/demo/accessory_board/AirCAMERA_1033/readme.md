...
本示例主要是展示 AirCAMERA_1033 的使用，本地拍摄照片或者视频录制后通过 httpplus 扩展库将图片或者视频上传至 air32.com
...
6、photo_to_aircloud.lua：执行拍照后上传照片至 aircloud平台

注意：take_photo_http_post.lua 和 video_http_post.lua 和 photo_to_aircloud.lua 和 rtmp_app.lua只能打开一个不能同时打开
...
- 每 30 秒触发一次拍照：AirCAMERA_1033_func()
...
- 释放资源 ：推流结束时excamera.close()关闭摄像头，释放资源
  ...
  ### 6、拍照上传业务模块（photo_to_aircloud.lua）
...
3、合宙标准配件 AirCAMERA_1033 一块

4、Air8101 核心板和合宙标准配件 AirCAMERA_1033 的硬件接线方式为
...
AirCAMERA_1033 配件板 + Air8101 核心板，硬件连接示意图：

单路摄像头链接方式

![](https://docs.openLuat.com/cdn/image/8101_1033_5.jpg)

四路摄像头链接方式
如图所示，将四路USB摄像头接入HUB中，然后将HUB通过USB口连接到Air8101核心板上;

![](https://docs.openLuat.com/cdn/image/8101_1033_3.jpg)
...
3、合宙标准配件 AirCAMERA_1033 + AirMICROSD_1000 配件板 各一块
...
![](https://docs.openLuat.com/cdn/image/8101_1033_6.jpg)
...
![](https://docs.openLuat.com/cdn/image/8101_1033_4.jpg)
...
3、合宙标准配件 AirCAMERA_1033 配件板 一块
...
AirCAMERA_1033 配件板与 Air8101核心板连接说明：

将 AirCAMERA_1033 配件板 直接接入 Air8101核心板 的USB接口即可

参考[AirCAMERA_1033 - 合宙模组资料中心](https://docs.openluat.com/accessory/AirCAMERA_1033/)

AirCAMERA_1033 配件板 + AirMICROSD_1000 配件板+ Air8101 核心板，硬件连接示意图：
