...
local function create_ui()
    ...
    airui.label({ parent = header, x = 10, y = 12, w = 500, h = 40, align = airui.TEXT_ALIGN_CENTER, text="IoT账户", font_size=32, color=0xffffff })

    content = airui.container({ parent = main_container, x=0, y=60, w=800, h=420, color=0xF3F4F6 })

    airui.label({ parent = content, x=50, y=40, w=150, h=40, text="服务器:", font_size=24, color=0x000000 })
    server_input = airui.textarea({ parent = content, x=210, y=40, w=350, h=40, placeholder = "mqtt://iot.com", font_size=20 })

    airui.label({ parent = content, x=50, y=100, w=150, h=40, text="账号:", font_size=24, color=0x000000 })
    user_input = airui.textarea({ parent = content, x=210, y=100, w=350, h=40, placeholder = "username", font_size=20 })

    airui.label({ parent = content, x=50, y=160, w=150, h=40, text="密码:", font_size=24, color=0x000000 })
    pass_input = airui.textarea({ parent = content, x=210, y=160, w=350, h=40, placeholder = "password", font_size=20 })
    ...
    airui.button({
        parent = content, x=120, y=320, w=150, h=50,
        text = "上传数据",
        font_size = 20,
        on_click = function()
            log.info("iot", "上传数据")
    ...
    airui.button({
        parent = content, x=340, y=320, w=150, h=50,
        text = "获取历史",
        font_size = 20,
        on_click = function()
            log.info("iot", "获取历史")
