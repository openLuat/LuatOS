...
local function create_ui()
    ...
    airui.label({ parent = header, x = 10, y = 12, w = 500, h = 40, align = airui.TEXT_ALIGN_CENTER, text = "APN配置", font_size = 32, color = 0xffffff })

    content = airui.container({ parent = main_container, x = 0, y = 60, w = 800, h = 420, color = 0xF3F4F6 })

    airui.label({ parent = content, x = 50, y = 50, w = 100, h = 40, text = "APN:", font_size = 24, color = 0x000000 })
    apn_input = airui.textarea({ parent = content, x = 160, y = 50, w = 300, h = 40, placeholder = "cmnet", font_size = 20 })

    airui.label({ parent = content, x = 50, y = 120, w = 100, h = 40, text = "账号:", font_size = 24, color = 0x000000 })
    user_input = airui.textarea({ parent = content, x = 160, y = 120, w = 300, h = 40, placeholder = "optional", font_size = 20 })

    airui.label({ parent = content, x = 50, y = 190, w = 100, h = 40, text = "密码:", font_size = 24, color = 0x000000 })
    pass_input = airui.textarea({ parent = content, x = 160, y = 190, w = 300, h = 40, placeholder = "optional", font_size = 20 })
