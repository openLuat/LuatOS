...
local function create_ui()
    ...
    time_label = airui.label({ parent = status_bar, x = 300, y = 10, w = 200, h = 48, text = current_time, font_size = 40, color = 0xfefefe, align = airui.TEXT_ALIGN_CENTER })
