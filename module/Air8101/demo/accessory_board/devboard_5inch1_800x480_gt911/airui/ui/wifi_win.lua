...
local function create_ui()
    ...
    airui.label({ parent = header, x = 0, y = 12, w = 800, h = 40, align = airui.TEXT_ALIGN_CENTER, text="WiFi", font_size=32, color=0xffffff })
    ...
    airui.textarea({ parent = content, x=20, y=310, w=300, h=40, placeholder = "密码", font_size=18 })
end
