...
<tr>
<td><img src="https://docs.openluat.com/cdn/image/devboard_5inch1_800x480_component_page.png" width="80" /><br/></td><td>
...
devboard_5inch1_800x480_default_font_page.png" width="80" /><br/></td><td>
<img src="https://docs.openluat.com/cdn/image/devboard_5inch1_800x480_home_page.png" width="80" /><br/></td></tr>
</table>
...
- USB 转串口供电下载扩展板 × 1
- LCD 扩展板 × 1
- 800*480 分辨率横屏 5.1 寸 LCD+ 触摸面板配件 × 1
- 50PIN FPC 连接线 x 1
- TYPE-C 数据线 × 1
- Air8101开发板底板 和 LCD 扩展板LCD 扩展板 以及800*480 分辨率横屏 5.1 寸 LCD+ 触摸面板配件的硬件接线方式为

  - Air8101开发板底板DL_UART0接口连接USB 转串口供电下载扩展板；
  - Air8101开发板底板J22接口通过50PIN FPC 连接线LCD 扩展板；
  - LCD 扩展板RGB888接口接800*480 分辨率横屏 5.1 寸 LCD+ 触摸面板配件显示排线
  - LCD 扩展板RGB-HNX接口接800*480 分辨率横屏 5.1 寸 LCD+ 触摸面板配件触摸排线
  

#### 3.2 接线图
![](https://docs.openluat.com/air8101/luatos/common/hwenv/image/CE8rbgTuSoh5FHxluljcdNbgnTc.png)
