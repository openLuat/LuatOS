...
local function create_ui()
    ...
    airui.label({ parent = header, x = 0, y = 12, w = 800, h = 40, align = airui.TEXT_ALIGN_CENTER, text="GPS", font_size=32, color=0xffffff })
    ...
    coord_label = airui.label({ parent = content, x=190, y=40, w=570, h=40, text="等待定位...", font_size=24, color=0x000000 })
