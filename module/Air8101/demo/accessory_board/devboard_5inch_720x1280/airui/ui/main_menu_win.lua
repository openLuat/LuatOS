...
local function create_ui()
    ...
    time_label = airui.label({ parent = status_bar, x = 260, y = 16, w = 200, h = 48, text = current_time, font_size = 44, color = 0xfefefe, align = airui.TEXT_ALIGN_CENTER })
    ...
    for i, app in ipairs(apps) do
        ...
        airui.image({ parent = cell, x = (cell_w-56)/2, y = 15, w = 56, h = 56, src = app.icon })
        airui.label({
            parent = cell,
            x = 0,
            y = 85,
    ...
    local btn_left = airui.container({ parent = bottom_bar, x = 0, y = 0, w = 360, h = 80, color = 0x2195F6, on_click = function() exwin.close(win_id) end })
    ...
    local btn_right = airui.container({ parent = bottom_bar, x = 360, y = 0, w = 360, h = 80, color = 0xFF9A27 })
