...
function default_font_page.create(ui)
    ...
    -- ==================== 字体特性说明 ====================
    local feature_start_y = start_y + 320
    
    local feature_title = ui.label({
        x = start_x, y = feature_start_y,
        text = "默认字体特性说明:",
        color = ui.COLOR_BLACK,
        size = 16
    })
    ...
    local feature1_title = ui.label({
        x = start_x + 20, y = feature_start_y + 40,
        text = "-固定大小特性:",
        color = ui.COLOR_BLUE,
        size = 12
    })
    ...
    local feature1_desc = ui.label({
        x = start_x + 40, y = feature_start_y + 60,
        w = 640,
    ...
    local feature2_title = ui.label({
        x = start_x + 20, y = feature_start_y + 90,
        text = "-硬件要求:",
        color = ui.COLOR_GREEN,
        size = 12
    })
    ...
    local feature2_desc = ui.label({
        x = start_x + 40, y = feature_start_y + 110,
        w = 640,
    ...
    local feature3_title = ui.label({
        x = start_x + 20, y = feature_start_y + 140,
        text = "-性能优势:",
        color = ui.COLOR_RED,
        size = 12
    })
    ...
    local feature3_desc = ui.label({
        x = start_x + 40, y = feature_start_y + 160,
        w = 640,
    ...
    local feature4_title = ui.label({
        x = start_x + 20, y = feature_start_y + 190,
        text = "-字符集支持:",
        color = ui.COLOR_MAGENTA,
        size = 12
    })
    ...
    local feature4_desc = ui.label({
        x = start_x + 40, y = feature_start_y + 210,
        w = 640,
    ...
    local feature5_title = ui.label({
        x = start_x + 20, y = feature_start_y + 240,
        text = "-适用场景:",
        color = ui.COLOR_ORANGE,
        size = 12
    })
    ...
    local feature5_desc = ui.label({
        x = start_x + 40, y = feature_start_y + 260,
        w = 640,
