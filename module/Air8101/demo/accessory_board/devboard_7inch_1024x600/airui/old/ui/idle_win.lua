...
local function create_ui()
    ...
    time_label = airui.label({ parent = status_bar, x = 0, y = 10, w = 1024, h = 48, text = "08:00", font_size = 40, color = 0xfefefe, align = airui.TEXT_ALIGN_CENTER })
    ...
    -- 常用应用图标（一行5个）
    local cell_w = 90
    local start_x_apps = (1024 - cell_w * 5) / 2
