...
local function create_ui()
    ...
    signal_img = airui.image({ parent = status_bar, x = 974, y = 14, w = 40, h = 40, src = full_path })
    time_label = airui.label({ parent = status_bar, x = 0, y = 10, w = 1024, h = 48, text = current_time, font_size = 40, color = 0xfefefe, align = airui.TEXT_ALIGN_CENTER })
    ...
    local btn_left = airui.container({ parent = bottom_bar, x = 0, y = 0, w = 512, h = 60, color = 0x2195F6, on_click = function() exwin.close(win_id) end })
    ...
    local btn_right = airui.container({ parent = bottom_bar, x = 512, y = 0, w = 512, h = 60, color = 0xFF9A27 })
