...
function home_page.create()
    ...
    local subtitle = ui.label({
        x = 362,           -- 居中显示
        y = 95,
        text = "基于exEasyUI v1.7.0开发 - 1024*600分辨率",
        color = ui.COLOR_GRAY,
        size = 16
    })

    -- 按钮布局 - 使用1024宽度的新布局
    local btn_width = 440  -- 按钮宽度增大
    local btn_height = 70  -- 按钮高度增大
    local btn_x = 40       -- 左侧起始位置
    local btn_spacing = 80 -- 按钮间距
