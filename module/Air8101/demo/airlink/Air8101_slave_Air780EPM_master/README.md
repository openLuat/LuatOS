...
2、内核固件：使用大于等于2004版本号的[内核固件](https://docs.openluat.com/air8101/luatos/firmware/)，开发验证本demo时，还没有正式版本的固件，所以使用[Air8101 临时固件，仅用于验证](https://devsnap.luatos.com/air8101v2/LuatOS-SoC_V2001_Air8101_101_20260115_110913.soc)。
