...
local function ui_main()
    ...
    -- 修改 slider2 取值范围
    airui.button({
        text = "Set Range 0-200",
        x = 40, y = 220, w = 150, h = 44,
        on_click = function()
