...
local function create_ui()
    ...
    time_label = airui.label({ parent = status_bar, x = 140, y = 10, w = 200, h = 48, text = "08:00", font_size = 40, color = 0xfefefe, align = airui.TEXT_ALIGN_CENTER })
    ...
    local start_x = (480 - total_width) / 2
    local qr_y = 190
    ...
    -- 常用应用图标（一行5个）
    local cell_w = 96
    local start_x_apps = (480 - cell_w * 5) / 2
    ...
    for i, app in ipairs(apps) do
        ...
        airui.image({ parent = cell, x = (cell_w-40)/2, y = 10, w = 40, h = 40, src = app.icon })
        airui.label({
            parent = cell,
            x = 0,
            y = 60,
    ...
    local btn_left = airui.container({ parent = bottom_bar, x = 0, y = 0, w = 240, h = 60, color = 0xFF9A27 })
