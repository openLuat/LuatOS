...
## 演示硬件环境
 ...
 Air8201H 整机板（基于Air780EHM模组）+喇叭

- 具备volte功能的电话卡插入开发板的sim卡槽

2、TYPE-C USB数据线一根
- Air8201H通过 TYPE-C USB 口供电；
...
2、Air8201H 固件，选择支持对讲功能的固件，[不同版本区别](https://docs.openluat.com/air780epm/luatos/firmware/version/)

3、 luatos需要的脚本和资源文件
- 脚本和资源文件[点我浏览所有文件](https://gitee.com/openLuat/LuatOS/tree/master/module/Air8201/demo/airtalk/Air8201H)
...
7、 点击BOOT 按键，会选择指定终端ID的目标设备，进行一对一对讲，再按一次Boot键或powerkey键结束对讲。
- 按下Boot键，启动一对一对讲流程
...
8、 点击POWERKEY按键，会进行广播，所有群组内的人，都会收到对讲消息，再按一次Boot键或powerkey键结束广播。
- 按下Power键，启动广播对讲
...
9、当其他设备或手机/PC的web网页端对设备发起一对一对讲。
