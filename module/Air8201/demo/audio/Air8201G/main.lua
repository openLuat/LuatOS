...
--[[
本demo适配 Air8201G 整机板，可直接在 Air8201G 板子上运行。
Air8201G 板载 ES8311 音频编解码芯片，音频引脚配置为：i2c_id=0、pa_ctrl=25、dac_ctrl=2，
各功能模块中的 audio_setup_param 已按此配置好，无需外挂 AirAUDIO 配件板。
]]
