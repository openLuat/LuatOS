...
Air8201G 基于 Air780EGH 模组, 整机板上**板载 ES8311 音频编解码芯片**, 无需外挂 AirAUDIO 配件板即可使用音频功能。

本目录下各功能模块中的 `audio_setup_param` 已按 Air8201G 整机板的硬件配置好, 引脚对应关系如下:
...
2、[Air8201G LuatOS固件](https://docs.openluat.com/air780egh/luatos/firmware/version/)，选择支持TTS功能的固件（如需使用TTS功能）。
