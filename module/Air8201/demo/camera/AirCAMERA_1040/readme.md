...
4、Air8201配套的BTB扩展板一个

5、Air8201G/H 开发板和合宙标准配件 AirCAMERA_1040 的硬件接线方式为

Air8201G/H 开发板通过FPC线与BTB扩展板连接；

TYPE-C USB 数据线直接插到BTB扩展板的 TYPE-C USB 座子，另外一端连接电脑 USB 口；

AirCAMERA_1040 配件板插入BTB扩展板的摄像头座子中
...
3、短按PWRKEY按键或等待自动拍照完成后上传平台，LUATOOLS会有如下打印;
```lua
...
```
4、短按PWRKEY按键或等待自动扫描任务完成后，LUATOOLS会有如下打印;
```lua
...
[2025-11-21 15:19:17.319][000000000.541] I/user.扫码结果 Air8201
[2025-11-21 15:19:17.323][000000000.542] I/user.扫描完成，扫描结果为： Air8201
[2025-11-21 15:19:17.327][000000000.542] I/user.Scan result : Air8201
```
