...
> 本目录为 **Air8201**（基于 Air780EGH / Air780EHM 模组）的 ftp demo。支持 4G 和 PC 模拟器两种联网方式，无需 SPI 以太网卡，统一适配 Air8201G 和 Air8201H。
...
3、[Air8201H固件](https://docs.openluat.com/air780epm/luatos/firmware/version/#air780ehmluatos)
