# **SIP DEMO 项目说明（Air8201G）**

## **一、项目概述**

Air8201G 基于 Air780EGH 模组，BTB扩展板引出了SPI接口，支持通过SPI外挂CH390H芯片实现以太网联网。

SIP DEMO 项目是一个基于 Air8201G 开发板的 SIP 通话演示项目，通过 Air8201G 开发板实现 SIP 通话功能，支持 4G、以太网两种网络方式以及多网融合情况下的 SIP 通话。
