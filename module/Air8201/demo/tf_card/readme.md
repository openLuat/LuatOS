## Air8201 tf_card demo 说明

> **本 demo 仅支持 Air8201G**（基于 Air780EGH 模组，BTB 扩展板已板载 TF 卡槽）。
>
> Air8201H（基于 Air780EHM 模组）的 BTB 扩展板未板载 TF 卡槽，**不支持 TF 卡（SD 卡）功能**。
...
1、Air8201G 整机板一个，BTB扩展板一个（BTB 扩展板已板载 TF 卡槽）；
