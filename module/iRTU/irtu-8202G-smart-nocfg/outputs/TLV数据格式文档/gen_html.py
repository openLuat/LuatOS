# -*- coding: utf-8 -*-
"""将 TLV 文档 md 转为适合打印/转 PDF 的 HTML（工业风浅色，A4 友好）。"""
import os
import markdown

BASE = r"D:\dev\LuatOS\module\iRTU\irtu-8202G-smart-nocfg\outputs\TLV数据格式文档"
MD = os.path.join(BASE, "AirCloud TLV数据格式详解.md")
HTML = os.path.join(BASE, "AirCloud TLV数据格式详解.html")

with open(MD, encoding="utf-8") as f:
    text = f.read()

# markdown → html（图片相对路径基于 HTML 所在目录，天然可用）
...
<head>
<meta charset="utf-8">
<title>AirCloud TLV 数据格式详解</title>
<style>{CSS}</style>
</head>
<body>
{body}
