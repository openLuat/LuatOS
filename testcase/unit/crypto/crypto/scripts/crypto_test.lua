local crypto_tests = {}
-- 新固件不再开启 CCM 套件,期望列表中已移除所有 *-CCM / *-CCM-8 条目
local expected_suites = {"TLS-RSA-WITH-AES-128-CBC-SHA", "TLS-RSA-WITH-AES-128-CBC-SHA256",
                         ...
                         "TLS-RSA-PSK-WITH-AES-256-CBC-SHA", "TLS-RSA-PSK-WITH-AES-128-GCM-SHA256",
...
function crypto_tests.test_crc16_modbus_contrast()
    ...
    local data_user = crypto.crc16("USER-DEFINED", "123456sdfdsfdsfdsffdsfdsfsdfs1234", 0x8005, 0xFFFF, 0x0000, 1, 0)
